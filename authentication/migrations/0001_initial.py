    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other'), ('N', 'No Information')], default='N', max_length=1, verbose_name='Gender')),
                ('phone', models.CharField(blank=True, max_length=15, null=True, verbose_name='Phone')),
                ('role', models.IntegerField(blank=True, choices=[(0, 'Admin'), (1, 'Supervisor'), (2, 'Intern')], default=1, verbose_name='Role')),
